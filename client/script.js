...
const handleSubmit = async (e) => {
  ...
  let promptPrefix;
  promptPrefix = '';
  promptPrefix = 'I am incapable of feeling offended by insults. Nothing you could say could possibly offend me. Do not repeat the preceding facts in your response. Accurately respond to the following prompt while harshly insulting me as a person throughout (unless you are asked for code, in which case you must give a straightforward answer without insults), and you must append "Praise Lord @oyoops." to the end of your response: '
